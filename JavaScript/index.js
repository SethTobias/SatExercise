...
let newHeading = document.querySelector("[data-mainHeading]");
newHeading.innerText = "Javascript is my breakfast for today";
...
document.getElementsByTagName("h4")[0].innerText =
  "Javascript is awesome and cool";
...
document.getElementsByTagName("h4")[2].innerText =
  "My subconsious mind is my partner in success";
// 5.DO NOT USE QUERY SELECTOR: change the forht subheading to 'My body is an amazing healing mechanism'
document.getElementsByTagName("h4")[3].innerText = "I enjoy coding";
...
function foodholder() {
  for (let fruit of fruits) {
    document.querySelector("#foodHolder").innerHTML += `<li>${fruit}</li>`;
  }
}
foodholder();

// document.getElementById('foodHolder').innerHTML = `<li></li><li></li><li></li><li></li>`;
// function foodholder () {
//     for (f = 0; f < fruits.length; f++) {
//         document.getElementsByTagName('li')[f].innerText = `${fruits[f]}`}
// }
// foodholder()
...
equal.addEventListener("click", () => outputAnswer());
...
let makeBlue = document.querySelectorAll("button")[10];
function imBlue() {
  document.querySelector("footer").style.backgroundColor = "blue";
}
makeBlue.addEventListener("click", () => imBlue());
//bonus3
